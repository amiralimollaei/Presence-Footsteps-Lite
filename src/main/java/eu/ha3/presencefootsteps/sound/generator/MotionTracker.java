    ...
    public void simulateMotionData(LivingEntity ply) {
        if (PlayerUtil.isClientPlayer(ply)) {
            ...
            if (Minecraft.getInstance().isLocalServer()) {
                ...
                // On dedicated servers, the local player's moveDist does not advance in the
                // same way as singleplayer. Use the same motion-based accumulation model we
                // already use for remote players so cadence stays consistent.
